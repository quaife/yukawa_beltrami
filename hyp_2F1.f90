...
FUNCTION LOG_A_SUM_INIT(M,EPS)
  ...
  INTEGER(IPR) :: N
  REAL(PR)     :: LOG_FACT
  COMPLEX(PR)  :: ONE_MEPS_MM,LOG_A_SUM_INIT,LOG_GAMMA
  !
...
FUNCTION HYP_PS_ONE(A,B,C,MZP1)
  ...
  COMPLEX(PR)  :: B_EXTRA_TERM,B_TERM,B_SUM,GAMMA_C,LOG_GAMMA,RATIO
...
FUNCTION HYP_PS_INFINITY(A,B,C,Z)
  ...
  INTEGER(IPR) :: N,M,PHASE,M_M2,MIN_N,MIN_N_CALC,M_P1
  REAL(PR)     :: B_PREC,N_P1,N_PM_P1,CV_POLY_DER_CALC
  COMPLEX(PR)  :: B_SUM_INIT_PS_INFINITY,LOG_GAMMA,POW_Z_INV_M
