...
= \delta(x-x_{0})$, where $\delta$ is the usual dirac delta function.
...
\bibitem{hackbusch}
Hackbusch, W.: Integral equations, \emph{International Series of Numerical
  Mathematics}, vol. 120.
\newblock Birkh\"auser Verlag, Basel (1995).
\newblock \doi{10.1007/978-3-0348-9215-5}.
\newblock \urlprefix\url{http://dx.doi.org/10.1007/978-3-0348-9215-5}.
\newblock {Theory and numerical treatment, Translated and revised by the author
  from the 1989 German original}
