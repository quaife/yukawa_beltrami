...
\begin{proof}
\todo{Bryan: Check bolding in this proof}
...
%operator can therefore be made continuous in the arclength parameter.
%
...
$q(x,x_{0})$ is continuous \todo{Nilima: we need it to be smooth} as
...
\todo{Nilima: We need it to be smooth.  I tried taking derivatives with
Maple and had no problems}.  The second term involving $Q_{\nu}(-z)$ is
...
\begin{align*}
  ...
  &= A(1+z)\log(1+z) + B(1+z),
%tQ_{\nu}(t) - Q_{\nu+1}(t) &= t\left(-\frac{1}{2}\log(1-t) + 
%  R(\nu) + \bigO(1-t)\right) - \left(-\frac{1}{2}\log(1-t) + 
%    R(\nu+1) + \bigO(1-t)\right) \\
%    &=-\frac{1}{2} (t-1)\log(1-t) + [\psi(\nu+1)-\psi(\nu+2)] + \bigO(1-t) + \big(t(1-t)).
\end{align*}
