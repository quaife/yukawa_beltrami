...
For $x\notin\Gamma, x\in \Omega$, the single layer potential in \eqref{singlelayerpotential} satisfies:
\begin{align*}
...
Similarly, the double layer potential in \eqref{doublelayerpotential} satisfies the Yukawa-Beltrami
